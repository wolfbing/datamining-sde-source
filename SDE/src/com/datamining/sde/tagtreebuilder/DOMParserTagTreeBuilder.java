 ...
 */
package com.datamining.sde.tagtreebuilder;
...
public class DOMParserTagTreeBuilder implements TagTreeBuilder
{
	...
	public TagTree buildTagTree(InputSource htmlDocument, boolean ignoreFormattingTags)  throws IOException, SAXException
	{
		return buildTagTree(htmlDocument.toString(), ignoreFormattingTags);
	}
...
//	{
	public TagTree buildTagTree(String inputSource, boolean ignoreFormattingTags) throws IOException, SAXException 
	{
		TagTree tree = null;
				...
				if ( !arrayContains(ignoredTags, tagCode) )
				{
					...
					else if( tagCode == HTMLElements.A )
					{
						...
						if ( attributesMap.getNamedItem("href") != null)
						{
							...
							System.out.println("linkURI:"+linkText);
